...
export default function PostCard({ post, onDelete }: PostCardProps) {
  ...
  return (
    <div className="w-full">
      <Card className="bg-transparent/10 backdrop-blur-md border border-white/20 rounded-lg shadow-lg">

        <CardHeader className="text-xl font-semibold text-white p-4 border-b border-white/20 drop-shadow-md">
          {post.title.substring(0, 50)}
        </CardHeader>

        <CardBody className="p-4 text-white/90 drop-shadow-md">
        ...
        <CardFooter className="p-4 flex justify-end gap-2 border-t border-white/20">
